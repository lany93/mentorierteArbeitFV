...
Die Schnittpunkte an denen mindestens drei Flächen und damit mindestens drei Kanten aufeinandertreffen, bezeichnen wir als \textbf{Ecken}. Ein Tetraeder besitzt beispielsweise 6 Kanten und 4 Ecken (siehe Abbildung \ref{fig:tetraeder}).
...
\begin{figure}[htbp]
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{images/polyeder/kuppelhaus_düsseldorf.jpg}
         \caption{Botanischer Garten in Düsseldorf.}
...
\end{comment}
Das quaderförmige Paket in Abbildung \ref{fig:Paket} erfüllt die Flächenregularität zum Beispiel nicht, da die Seitenflächen nicht kongruente, reguläre Vielecke sind. Ein Polyeder, welches die Eckenregularität verletzt, ist zum Beispiel ein gestrecktes Oktaeder (siehe Abbildung \ref{fig:oktaeder}).
An den Ecken $E$ und $B$ treffen zwar jeweils vier Dreiecke aufeinander, jedoch ist der Winkel zwischen den Kanten an der Ecke $E$ viel spitzer als an der Ecke $B$. Somit ist die Anordnung nicht diesselbe.
\begin{figure}[htp]
\centering
\includegraphics[width=0.4\textwidth]{images/polyeder/oktaeder.png}
\caption{Gestrecktes Oktaeder mit $a<s$.}
\label{fig:oktaeder}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Reguläres Hexaeder}: (griech. \textit{hex} = sechs) Der Würfel wird begrenzt von sechs Quadraten.
...
\begin{exercise} \label{ex:polyederbeispiele}
    ...
    \begin{itemize}
        ...
        \item[b)] Ein klassischer Spielwürfel.
    \end{itemize}
