...
\begin{itemize}
    \item Jede \textbf{Kante} gehört zu genau zwei Flächen.
...
An den Ecken $E$ und $A$ treffen zwar jeweils vier Dreiecke aufeinander, jedoch is der Winkel zwischen den Kanten an der Ecke $E$ viel spitzer als an der Ecke $A$. Somit ist die Anordnung nicht diesselbe.
\begin{figure}[htp]
\centering
\includegraphics[width=0.4\textwidth]{images/polyeder/oktaeder.png}
\caption{Gestrecktes Okateder mit $a \neq s$.}
\label{fig:oktaeder}
\end{figure}
