...
Zeigen Sie, dass jede Äquivalenzrelation auf einer Menge diese Menge in eine disjunkte Vereinigung von Äquivalenzklassen zerlegt.
\end{exercise}
...
Gehen Sie nochmals durch den Beweis von Satz \ref{satz:sum_projection_independent_of_plane}. Erkläre in eigenen Worten, wo die orthogonalen Projektionen verwendet werden im Beweis.
\end{exercise}
